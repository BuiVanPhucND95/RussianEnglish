...
public class CoppyDatabase extends SQLiteOpenHelper {
    static String DB_PATH = "/data/data/com.freelancer.buivanphuc.russianenglish/databases/";
    static String DB_NAME = "dictionary.sqlite";
    SQLiteDatabase db;
    private final Context mContext;

    public CoppyDatabase(Context context) {

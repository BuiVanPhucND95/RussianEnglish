...
public class FragmentInterjection extends Fragment {
    LinearLayout ln_general_information;
    IGetLinks iGetLinks;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.layout_interjection, container, false);
        ...
        ln_general_information.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                iGetLinks.getLink("interjection/general_information.html");
            }
        });
        return view;
    }
